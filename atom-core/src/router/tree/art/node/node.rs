...
//     base: BaseNode,
//     keys: [u8; 4],
//     children: [MaybeUninit<NodeLeaf<K, V>>; 4],
// }
//
...
//
//         self.keys[pos] = key;
//         self.children[pos] = MaybeUninit::new(node);
...
//                 unsafe {
//                     let old = mem::replace(&mut self.children[i as usize], MaybeUninit::new(val));
//                     return Some(old.assume_init_read());
//                 }
//             }
//         }
//         None
...
//                        return Some(child.assume_init_ref());
//                    }
//                }
//              }
//              None
